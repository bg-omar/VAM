...
In the Vortex \AE ther Model (VAM), the vorticity wave speed $v_v$ emerges from the relationship between the vorticity permeability constant $\mu_v$, the \AE ther density $\rho_{\text{\ae}}$, and the vortex-core radius $r_c$. The permeability constant is given by:

...
# Define parameters
theta = np.linspace(0, 2*np.pi, 100)  # Angular position
r = np.linspace(0.2, 2, 50)  # Radial distance
R, Theta = np.meshgrid(r, theta)  # Meshgrid for 3D plotting
...
plt.contourf(X, Y, vortex_intensity, cmap='plasma', levels=30)

...
ax.set_xlim(-6, 6)
ax.set_ylim(-6, 6)
ax.set_title("Gravitational æther inflow around mass M", fontsize=14)
...
ax.add_patch(vortex)
ax.plot(vortex_x + 0.4, vortex_y, 'ro', markersize=10)
ax.text(vortex_x, vortex_y - 1, 'Swirl clock', ha='center', fontsize=11)

# Æther speed label
ax.text(0, -5.6, r'Æther inflow velocity: $v_g(r) = \sqrt{2GM / r}$',
        fontsize=12, ha='center', color='black')

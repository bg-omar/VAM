...
%! Titel = Tijdsdilatatie in een 3D Superfluïde Æther Model, Gebaseerd op Wervel kernrotatie en ætherische Stroom
%! Datum = 23 mei 2025
...
\input{Tijdsdilatatie/1_introductie}
\input{Tijdsdilatatie/2_supervloeistof_æther_geraamte}
\input{Tijdsdilatatie/3_vortex_klokken}
\input{Tijdsdilatatie/4_speciale_relativiteit}
\input{Tijdsdilatatie/5_gravitationele_tijd_dilatatie}
\input{Tijdsdilatatie/6_gecombineerde_effecten}
\input{Tijdsdilatatie/7_conclusie}

\appendix \label{sec:Part-6}
\input{Tijdsdilatatie/appendix_A}
\input{Tijdsdilatatie/appendix_B}

\bibliographystyle{unsrt}
\bibliography{1-Tijdsdilatatie_in_3D_Superfluïde_Æther_Model}

...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=2]
        ...
        % Vectorveld label
        \node[blue!80] at (1.8,1.4) {$\vec{v}_\text{\ae}$ rond wervel};
...
Deze belangrijke relatie koppelt de fysieke vertraging van de spin $\omega_{\textrm obs}$ van de wervel aan de tijddilatatiefactor. Als $\omega_{\textrm obs} < \omega_0$, loopt de klok langzaam (aangezien $\Delta \tau < \Delta t$).
...
\end{enumerate}
We zullen ontdekken dat $\omega_{\textrm obs}/\omega_0$ in deze gevallen respectievelijk de bekende Lorentz- en gravitationele tijddilatatiefactoren reproduceert.
...
Voor een bespreking van hoe samengestelde klokken bestaande uit meerdere wervelknopen collectief tijddilatatie ondervinden, zie Appendix~\ref{appendix:KlokkenInWervelstructuren}.

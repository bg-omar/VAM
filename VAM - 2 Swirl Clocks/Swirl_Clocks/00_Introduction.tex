...
\subsection*{Temporal Constructs in VAM}
We adopt a layered temporal ontology to clearly define different manifestations of time in VAM, as detailed further in Appendix ÆthericNow~\cite{Iskandarani2025b}. Specifically, we distinguish between:
...
\begin{table}[htbp]
    ...
    \begin{tabular}{llc}
        ...
        \end{tabular}
    \caption{\textbf{Ætheric Time Modes — Quick Overview}}
\end{table}


These constructs ensure clarity when discussing vortex-induced time modulation and topological phenomena\footnote{\(\Xi_0\) denotes the stationary reference frame of the universal superfluid æther. All temporal constructs evolve relative to this frame.}.

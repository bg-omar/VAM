...
\begin{table}[htbp]
    ...
    \begin{tabular}{llc}
        ...
        $F^{\text{\ae}}_{\text{max}}$ & Maximale wervelkracht & $29.05$ N \\
...
\begin{equation}
    F^{\text{\ae}}_{\text{max}} = \frac{8\pi \rho_\text{\ae} r_c^3}{C_e}
\end{equation}
...
\begin{equation}
    \hbar = \sqrt{\frac{2M_e F^{\text{\ae}}_{\text{max}} r_c^3}{5 \lambda_c C_e}}
\end{equation}

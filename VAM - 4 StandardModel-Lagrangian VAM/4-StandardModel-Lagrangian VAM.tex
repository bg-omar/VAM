...
% ============= Begin of content ============
    ...
    \input{section/05_Emergent_Constants_from_Fluid_Analogs}
    \input{section/06_VariationalDerivationSwirlLagrangian}
    \input{section/07_CanonicalCommutatorsAndSwirlQuantization}
    \input{section/08_BoundaryGaugeConditions}
    \input{section/09_TopologicalOriginsOfParticleProperties}
    \input{section/10_MassAndInertiaFromVortexCirculation}
    \input{section/11_Knot_Taxonomy}
    \input{section/12_HelicityInterferenceSuppressionTermFromVortexKnotPacking}
    \input{section/13_DerivationOfBaryons}
    \input{section/14_General_Mass_Formula}
    \input{section/15_PressureAndStressPotentialOfTheÆtherCondensate}
    \input{section/16_MappingVAM_SwirlGroups}
    \input{section/17_SwirlOperatorAlgebraAndSU2}
    \input{section/18_ExtentionSU3}
    \input{section/19_SwirlInducedTimeAndInVortexKnots}
    \input{section/20_CorePressureMassAndTime}
    \input{section/21_conclusionanddiscussion}
    \input{section/22_EntropicSwirlGravity}
    \input{section/23_outlookvam_qft}

    \appendix
        \def\standalonechapter{false}
        \newpage\chapter*{I: Mass Generation \& Particle Structure}
        \input{section/A1_DerivationOfTheKineticEnergyOfACircularVortexLoop}
        \input{section/A2_EulerLagrangeDerivation}
        \input{section/A3_ConstraintHandlingLagrangeMultipliersVAMLagrangian}
        \input{section/A4_CalculateElectronHelicity}
        ...
        \input{section/A10_DerivationGravitationalFineStructure}
        ...
        \input{section/A15_EmergentInertialMassFromKnottedVortexHelicity}
        \input{section/A16_HyperbolicSuppressionInMassFormula}
        \input{section/A17_VAM_ReinterpretationVacuumRefractionAndPhotonScatteringExperiments}

...
Particle mass in VAM is not fundamental but derived from the energy stored in vortex tension and helicity. For a single knot with circulation $\Gamma$, core radius $r_c$, and æther density $\rho_{\æ}$, the mass is:

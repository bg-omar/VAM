...
\begin{gather*}
    \begin{array}{ccc}
            ...
            h = \frac{16 \pi F^{\text{\ae}}_{\text{max}}^2 R_c^3 a_0}{\hbar c^2} & R_\infty = \frac{C_e^3}{\pi R_c c^3} & C_e = \frac{R_c M_e c^2}{\hbar} \\
...
\begin{equation*}
    u_\text{vortex}(r, \omega, T) = \frac{F^{\text{gr}}_{\text{max}} \omega^3}{C_e r^2} \cdot \frac{1}{e^{\hbar \omega / k_B T} - 1}
\end{equation*}
\begin{equation*}
    s_\text{vortex}(r, T) = \frac{4 \pi^4 F^{\text{gr}}_{\text{max}} k_B^4 T^3}{45 C_e r^2 \hbar^4}
\end{equation*}
\begin{equation*}
    \Phi_\text{vortex} = \frac{\pi^4 F^{\text{gr}}_{\text{max}} k_B^4 T^4}{15 \hbar^4 r}
\end{equation*}
\begin{equation*}
    u_\text{total}(T) \propto \frac{F^{\text{gr}}_{\text{max}} T^4}{C_e r^2}
\end{equation*}
\begin{equation*}
    s_\text{total}(T) \propto \frac{F^{\text{gr}}_{\text{max}} T^3}{C_e r^2}
\end{equation*}
...
\[
u_\text{vortex}(r, \omega) = \frac{F^{\text{gr}}_{\text{max}} \omega^3}{C_e r^2}
\]
...
\[
s_\text{vortex}(r, \omega, T) = \frac{4 F^{\text{gr}}_{\text{max}} \omega^3}{3 T C_e r^2}
\]

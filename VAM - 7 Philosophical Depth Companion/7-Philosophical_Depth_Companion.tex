...
% -----------------------------
% VAM Monograph/Book Template (KOMA-Script)
% Based on scrreprt for beautiful long-form formatting
% -----------------------------
\documentclass[12pt, a4paper, oneside]{scrreprt} % Use 'twoside' for print-ready
...
% -----------------------------
\setcounter{tocdepth}{2}  % Chapters, sections, and subsections only
\RedeclareSectionCommand[beforeskip=-2ex plus -1ex minus -.2ex, afterskip=1.2ex plus .2ex]{section}
\RedeclareSectionCommand[beforeskip=-1.5ex plus -1ex minus -.2ex, afterskip=0.8ex plus .2ex]{subsection}
...
\mainmatter
    \newpage \input{001_introduction}
    \newpage \chapter{Part I}\label{sec:part-1}   \input{010_extension_physics}
    \newpage \input{020_History}
    \newpage \input{025_Maxwell_Electromagnetic_field_theory_and_VAM}
    \newpage \input{030_observations_on_gr}
    \newpage \input{040_why_3d}
    \newpage \input{050_æther_3D}
    \newpage \input{055_C_e_DerivationVorticitySuperfluid}
    \newpage \input{060_derivation_æther_desity}
    \newpage \input{070_observation_on_light_particle}
    \newpage \input{080_riged_body}
    \newpage \input{090_derevation_swirl}
    


    \newpage \chapter{Part II}\label{sec:part-2} \input{100_derevation_Gswirl}
    \newpage \input{110_VAM_reformulation_GR}
    \newpage \input{120_vam_derevation}
    \newpage \input{130_Magnetism_as_vorticity}
    \newpage \input{140_vortex_induced_magnetic_fields}
    \newpage \input{150_QM_VAM}
    \newpage \input{160_Atomic_Scale}
    \newpage \input{170_Radial_Function}
    \newpage \input{180_orbitals}
    \newpage \input{190_addressing_qed_corrections}
    \newpage \input{200_path_Integral_gauge_relativity}
    \newpage \input{210_bragg}
    \newpage \input{300_VortexKnotsQg}
    \newpage \input{310_QuantizedVorticity}
    \newpage \input{320_EmWavesFromQuantizedVortices}
    \newpage \input{340_VortexWaveVelocity}
    \newpage \input{350_VAM_MaxForce}
    \newpage \input{360_DerivationOfPlanck}
    \newpage \input{370_BlackbodyRadiationEntropy_VAM}

    \newpage \input{500_movement_of_free_Æther_particles}
    \newpage \input{510_vortex_pressure}
    \newpage \input{520_vorticity_natural_coords}
    \newpage \input{530_vorticity_derivation}
    \newpage \input{540_relative_vorticity_2knots}
    \newpage \input{550_why_coulomb_differs_in_electromagnetic_system}
    \newpage \input{560_Spin_Torsion_in_Vortices}
    \newpage \input{570_photon_vortex}
    \newpage \input{580_atomic_orbits_Vortex_Gravity_space_and_time}
    \newpage \input{590_Bridging_Knot_Theory_Particle_Physics}
    \newpage \input{600_Casimir_Effect}
    \newpage \input{610_BlackBody_radiation_entropy}
    \newpage \input{620_Æther_gas}
    \newpage \input{630_maxwell}
    \newpage \input{640_vortex_energy}
    \newpage \input{650_sprites}
    \newpage \input{660_oumuamua}
    \newpage \input{670_derive_vortex_wave_speed}
    \newpage \input{680_Stationary_Knotted_Vortex}
    \newpage \input{690_temp_swelling_latex_version}
    \newpage \input{700_temp_swelling}
    \newpage \input{250_eqs}

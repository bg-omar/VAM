...
\newpage
    ...
    %% Introduction
    \input{sections/000_Introduction}

    %% Part I - Foundational Considerations
    \newpage \section*{Part I: Foundational Considerations}\label{sec:Part-1} \input{sections/010_History}
    \newpage \input{sections/020_SuperfluidLikeÆther}
    \newpage \input{sections/030_FineStructureConstant}

    %% Part II - MathematicalFormalism
    \newpage \section*{Part II: Mathematical Formalism}\label{sec:Part-2} \input{sections/040_MaxForceVAM}
    \newpage \input{sections/050_SwirlVelocityConstant}
    \newpage \input{sections/060_DerivationVAMFieldEquation}
    \newpage \input{sections/070_MaxwellEquivalentsVorticity}
    \newpage \input{sections/080_ElectrostaticChargeElectricFieldsVAM}
    \newpage \input{sections/085_ElectroVortexDynamics}
    \newpage \input{sections/090_MachInspiredScalar}
    \newpage \input{sections/100_PhotonVortexDipole}
    \newpage \input{sections/110_PhotonVortexDipoleGravitationalCoupling}
    \newpage \input{sections/120_PhotonsDipoles}
    \newpage \input{sections/130_HeatTheoryVAM}


    %% Part III - Applications and Implications
    \newpage \section*{Part III: Applications and Implications}\label{sec:Part-3} \input{sections/135_toy_model}
    \newpage \input{sections/140_ElectronToroidalVortex}
    \newpage \input{sections/145_MeisnerEffect}
    \newpage \input{sections/146_DerivationElectrostatic}
    \newpage \input{sections/147_VAMvsEHD}
    \newpage \input{sections/150_DiscussionOutlook}


    %% Appendices
    \newpage \appendix \label{sec:Part-4} \input{sections/A1_DetailedDerivationSwirlVelocityConstant}\label{appendix:1}
    \newpage \input{sections/A2_PoissonLikeEquationVorticityGravity}\label{appendix:2}
    \newpage \input{sections/A3_MaxwellVAMIndexForm}\label{appendix:maxwell_appendix}
    \newpage \input{sections/A4_TimeDilationLocalTimeEquations}\label{appendix:TimeDilation}
    \newpage \input{sections/A5_Relation_QM_VAM}\label{appendix:5}
    \newpage \input{sections/A6_KnotTheoryConnections}\label{appendix:6}
    \newpage \input{sections/A7_DerivationFineStructureConstant}\label{appendix:alpha}
    \newpage \input{sections/A8_DerivationÆthericWave}\label{appendix:8}
    \newpage \input{sections/A9_DerivationVortexSwellingFormula}\label{appendix:9}
    \newpage \input{sections/A10_DerivationWaveEquation}\label{appendix:10}
    \newpage \input{sections/A11_DerivationGravitationalModification}\label{appendix:11}

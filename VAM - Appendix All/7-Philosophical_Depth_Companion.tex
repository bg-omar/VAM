...
\begin{document}
   ...
   \newpage \tableofcontents
    ...
    \newpage \input{sections/020_History}
    \newpage \input{sections/025_Maxwell_Electromagnetic_field_theory_and_VAM}
    \newpage \input{sections/030_observations_on_gr}
    \newpage \input{sections/040_why_3d}
    \newpage \input{sections/050_æther_3D}
    \newpage \input{sections/055_C_e_DerivationVorticitySuperfluid}
    \newpage \input{sections/060_derivation_æther_desity}
    \newpage \input{sections/070_observation_on_light_particle}
    \newpage \input{sections/080_riged_body}
    \newpage \input{sections/090_derevation_swirl}
    


    \newpage \chapter{Part II}\label{sec:part-2} \input{sections/100_derevation_Gswirl}
    \newpage \input{sections/110_VAM_reformulation_GR}
    \newpage \input{sections/120_vam_derevation}
    \newpage \input{sections/130_Magnetism_as_vorticity}
    \newpage \input{sections/140_vortex_induced_magnetic_fields}
    \newpage \input{sections/150_QM_VAM}
    \newpage \input{sections/160_Atomic_Scale}
    \newpage \input{sections/170_Radial_Function}
    \newpage \input{sections/180_orbitals}
    \newpage \input{sections/190_addressing_qed_corrections}
    \newpage \input{sections/200_path_Integral_gauge_relativity}
    \newpage \input{sections/210_bragg}
    \newpage \input{sections/300_VortexKnotsQg}
    \newpage \input{sections/310_QuantizedVorticity}
    \newpage \input{sections/320_EmWavesFromQuantizedVortices}
    \newpage \input{sections/340_VortexWaveVelocity}
    \newpage \input{sections/350_VAM_MaxForce}
    \newpage \input{sections/360_DerivationOfPlanck}
    \newpage \input{sections/370_BlackbodyRadiationEntropy_VAM}

    \newpage \input{sections/500_movement_of_free_Æther_particles}
    \newpage \input{sections/510_vortex_pressure}
    \newpage \input{sections/520_vorticity_natural_coords}
    \newpage \input{sections/530_FundamentalEquationsOfVortexDynamics}
    \newpage \input{sections/540_relative_vorticity_2knots}
    \newpage \input{sections/550_why_coulomb_differs_in_electromagnetic_system}
    \newpage \input{sections/560_Spin_Torsion_in_Vortices}
    \newpage \input{sections/570_photon_vortex}
    \newpage \input{sections/580_atomic_orbits_Vortex_Gravity_space_and_time}
    \newpage \input{sections/590_Bridging_Knot_Theory_Particle_Physics}
    \newpage \input{sections/600_Casimir_Effect}
    \newpage \input{sections/610_BlackBody_radiation_entropy}
    \newpage \input{sections/620_Æther_gas}
    \newpage \input{sections/630_maxwell}
    \newpage \input{sections/640_vortex_energy}
    \newpage \input{sections/650_sprites}
    \newpage \input{sections/660_oumuamua}
    \newpage \input{sections/670_derive_vortex_wave_speed}
    \newpage \input{sections/680_Stationary_Knotted_Vortex}
    \newpage \input{sections/690_temp_swelling_latex_version}
    \newpage \input{sections/700_temp_swelling}
    \newpage \input{sections/250_eqs}

...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{sections/1_vortexknopen}
    \caption{De torusknoop $T(2,3)$ als basismodel voor waterstof in het Vortex \AE ther Model. De tangentiële snelheid $C_e$ en kernstraal $r_c$ worden visueel aangeduid.}
    \label{fig:torus_t23}
\end{figure}

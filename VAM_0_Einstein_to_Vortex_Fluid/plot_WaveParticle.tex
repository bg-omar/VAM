\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{Development of wave–particle duality: from atomistic corpuscles and wave optics, through quantum superposition, to VAM’s unified vortex excitation model.}\label{fig:WaveParticleDuality}
\end{figure}
...
\begin{abstract}
            ...
            \( Borromean \):~\includegraphics[height=1.2em]{images/borromean} Proton \( Trefoil Knot (3,2) \):~\includegraphics[height=1.2em]{images/3_1} Neutrino \\
            \( 6_2 \):~\includegraphics[height=1.2em]{images/6_2} Up-Quarck \( 7_4 \):~\includegraphics[height=1.2em]{images/7_4} Down-Quarck  \\
            \( Figure-8-knot \):~\includegraphics[height=1.2em]{images/4_1} Dark Matter / Energy

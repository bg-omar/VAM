...
\newcommand{\dotmarker}[1]{\tikz[baseline]{\node[fill=#1,circle,inner sep=1.5pt]{};}}
  ...
  \input{../../SwirlStringTheory/template/SST_appendix_setup.sty}
  \begin{document}
...
\noindent\raggedright \section{\noindent\raggedright The SST Mass Formula}
The SST mass of a particle or atomic structure is given by:

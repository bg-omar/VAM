...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.65\textwidth]{swirltorus36 knots.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\textwidth]{02_Starship-3phase-27x3points_030557.png}
  \includegraphics[width=0.48\textwidth]{02_Starship-3phase-36points_222249.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\textwidth]{8knot.png}
...
\appendix
    ...
    \end{equation}
    as derived in \cite{VAM4}. This equation governs the phase‐space dynamics of the ætheric swirl field.
    ...
    \section{Derivation of Axisymmetric Reduction}\label{sec:AxisymmetricReduction}
        We derive here the axisymmetric reduction for the effective Lagrangian and Hamiltonian–Jacobi functional introduced in Section~5, based on swirl dynamics developed in \cite{VAM1, VAM2, VAM4}. Cylindrical coordinates $(r, \phi, x)$ are used, with the assumption of axial symmetry: $\partial_\phi = 0$.
        ...
        \end{equation}
        which has only an azimuthal component and depends on $r$ and $x$. This ansatz is consistent with the toroidal-poloidal decomposition of swirl fields used in \cite{VAM10}.

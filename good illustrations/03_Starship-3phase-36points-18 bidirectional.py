...
def plot_rodin_coil():
    ...
    ax.plot(x1, y1, z1, color=colors1[0],alpha=0.2, linewidth=2, label="Phase 1")
    ax.plot(x2, y2, z2, color=colors1[1],alpha=0.2, linewidth=2, label="Phase 2")
    # ax.plot(x3, y3, z3, color=colors1[2], linewidth=2, label="Phase 3")

    # Plot 3-phase Rodin coil windings
    (x1, y1, z1), (x2, y2, z2), (x3, y3, z3) = generate_rodin_3phase(-R, r)
    ax.plot(x1, y1, z1, color=colors2[0],alpha=0.2, linewidth=2, label="Phase 1")
    ax.plot(x2, y2, z2, color=colors2[1], alpha=0.2,linewidth=2, label="Phase 2")

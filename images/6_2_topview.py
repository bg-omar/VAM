...
ax.set_aspect('equal')
ax.axis('off')
plt.title(r'$6_2$ Knot - Top View', fontsize=14)

# Save the figure
output_path = "knot_6_2_topview.png"
...
ax.set_aspect('equal')
ax.axis('off')
plt.title(r'$7_4$ Knot - Top View', fontsize=14)

# Save the figure
output_path = "knot_7_4_topview.png"
plt.savefig(output_path, dpi=300, bbox_inches='tight')


# Create 3D plots for the 6_2 and 7_4 knots
...
ax1.set_title(r'$6_2$ Knot - 3D View', fontsize=14)
ax1.axis('off')
...
ax2.set_title(r'$7_4$ Knot - 3D View', fontsize=14)
ax2.axis('off')

# Save the figure
output_path = "knots_6_2_and_7_4_3D.png"
plt.savefig(output_path, dpi=300, bbox_inches='tight')
...
ax1.set_title(r'$6_2$ Knot - Top View', fontsize=12)
ax1.set_xlabel("X")
ax1.set_ylabel("Y")
...
ax2.set_title(r'$6_2$ Knot - Side View', fontsize=12)
ax2.set_xlabel("X")
ax2.set_ylabel("Y")
ax2.set_zlabel("Z")
...
ax3.set_title(r'$7_4$ Knot - Top View', fontsize=12)
ax3.set_xlabel("X")
ax3.set_ylabel("Y")
...
ax4.set_title(r'$7_4$ Knot - Side View', fontsize=12)
ax4.set_xlabel("")
ax4.set_ylabel("Y")
...
# Save the figure
output_path = "knots_6_2_and_7_4_3D_views.png"
plt.savefig(output_path, dpi=300, bbox_inches='tight')

...
base_sequence = [1, 6, 11, 4, 9, 2, 7, 12, 5, 10, 3, 8, 1]  # This sequence should only use 9 unique points
...
angles = np.linspace(0, 2 * np.pi, 13)[:-1]  # 9 points in a circular arrangement

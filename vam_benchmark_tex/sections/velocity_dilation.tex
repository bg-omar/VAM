...
\]
which mimics the event horizon~\cite{grin3d2025}.
...
\]
This ensures frame-dragging only applies macroscopically. At atomic scales, $\mu(r) \ll 1$, thus suppressing excessive frame-dragging from small spinning particles~\cite{grin3d2025,adelberger2003tests}.

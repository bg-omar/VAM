...
\begin{tikzpicture}[scale=1.1, >=Stealth, every node/.style={font=\small}]
    ...
    % Labels
        \node[align=center, font=\footnotesize] at (-3,-1.8) {Pure rotatie met \\lokale tangentiële snelheid \\$v_T = R\omega$.};
        \node[align=center, font=\footnotesize] at (1,-1.8) {Translatie met snelheid\\ $v_{cm}$ zonder rotatie.};
        \node[align=center, font=\footnotesize] at (5.5,-1.8) {Gecombineerde beweging \\met variërende relatieve snelheid \\over de vortex.};

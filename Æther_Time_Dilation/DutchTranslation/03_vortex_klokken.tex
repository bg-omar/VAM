...
Deze belangrijke relatie koppelt de fysieke vertraging van de spin $\omega_{\rm obs}$ van de wervel aan de tijdsdilatatiefactor. Als $\omega_{\rm obs} < \omega_0$, loopt de klok langzaam (aangezien $\Delta \tau < \Delta t$).
